...
public class Agencia {
    ...
    @SequenceGenerator(name = "label_sequence", sequenceName = "label_sequence", allocationSize = 3)
    private Integer id;

    @NotBlank(message = "O numero nao pode ser nulo ou invalido")
    @Column(name = "numero")
    ...
    public @NotBlank(message = "O numero nao pode ser nulo ou invalido") Integer getNumero() {
        return numero;
    }

    public void setNumero(@NotBlank(message = "O numero nao pode ser nulo ou invalido") Integer numero) {
        this.numero = numero;
    }
